    ...
    >
      ...
      <div className="max-w-2xl mx-auto space-y-8">
        <div className="text-center">
          ...
          >
            Tools serangan DDoS dengan tampilan UI yang imut & lucu.
          </p>
        </div>
          ...
          <div className="mb-6 space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <input
                ...
                placeholder="Masukkan URL atau IP target"
                className={`${
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  ...
                  {isAttacking ? "Hentikan Serangan" : "Mulai Serangan"}
                </button>
                <button
                  onClick={() =>
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            <div className="p-4 rounded-lg bg-gradient-to-br from-pink-500/10 to-blue-500/10">
              <div className="flex items-center gap-2 mb-2 text-pink-600">
                ...
                <span className="font-semibold">Paket/detik</span>
              </div>
              <div
            ...
            <div className="p-4 rounded-lg bg-gradient-to-br from-pink-500/10 to-blue-500/10">
              <div className="flex items-center gap-2 mb-2 text-pink-600">
                ...
                <span className="font-semibold">Bot Aktif</span>
              </div>
              <div
                className={`text-2xl font-bold ${
                  animState === 0 || animState === 3
            ...
            <div className="p-4 rounded-lg bg-gradient-to-br from-pink-500/10 to-blue-500/10">
              <div className="flex items-center gap-2 mb-2 text-pink-600">
                ...
                <span className="font-semibold">Paket Terkirim</span>
              </div>
              <div
                className={`text-2xl font-bold ${
                  animState === 0 || animState === 3
        ...
        <div className="flex flex-col items-center">
          <span className="text-sm text-center text-gray-500">
            🎵 v1.0 made by{" "}
            <a
              href="https://instagram.com/kky_krnwn331"
              target="_blank"
              rel="noreferrer"
            >
              @kkykrnwn
